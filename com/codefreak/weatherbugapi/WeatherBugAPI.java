...
import com.codefreak.weatherbugapi.containers.Forecast;
import com.codefreak.weatherbugapi.containers.ForecastDay;
import com.codefreak.weatherbugapi.containers.LiveWeather;
import com.codefreak.weatherbugapi.containers.Location;
import com.codefreak.weatherbugapi.containers.Station;
	...
	static {
		try {
			...
			logger.fatal("Could not load weatherbugapi.properties! Please create a 'weatherbugapi.properties' file" +
					"in com.codefreak.weatherbugapi and include 'apikey=YOUR_API_KEY'.");
		}
	}
